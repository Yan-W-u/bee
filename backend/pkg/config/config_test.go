...
func TestGetSecretPatterns_PatternCompilation(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			name: "DeepSeek",
			config: &Config{
				DeepSeekAPIKey: "test-sk-key",
			},
		},
		{
			name: "Kimi",
			config: &Config{
				KimiAPIKey: "test-sk-key",
			},
		},
		{
			name: "Qwen",
			config: &Config{
				QwenAPIKey: "test-sk-key",
			},
		},
		{
			name: "Tavily",
		...
		},
		{
			name: "Bedrock",
			config: &Config{
				BedrockAccessKey:    "test-aws-access-key",
				BedrockSecretKey:    "test-aws-secret-key",
				BedrockBearerToken:  "test-bearer-token",
				BedrockSessionToken: "test-aws-session-token",
			},
		},
		{
			name: "Langfuse",
			config: &Config{
				...
				LangfuseSecretKey: "test-langfuse-secret-key",
			},
		},
		{
			name: "Proxy",

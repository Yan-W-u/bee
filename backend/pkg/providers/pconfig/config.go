...
const (
	...
	OptionsTypeExplainer   ProviderOptionsType = "explainer"
	OptionsTypeRemediator  ProviderOptionsType = "remediator"
...
var AllAgentTypes = []ProviderOptionsType{
	...
	OptionsTypeExplainer,
	OptionsTypeRemediator,
}
...
type ProviderConfig struct {
	...
	Explainer      *AgentConfig      `json:"explainer,omitempty" yaml:"explainer,omitempty"`
	Remediator     *AgentConfig      `json:"remediator,omitempty" yaml:"remediator,omitempty"`
...
func (pc *ProviderConfig) GetOptionsForType(optType ProviderOptionsType) []llms.CallOption {
	...
	case OptionsTypeExplainer:
		agentConfig = pc.Explainer
	case OptionsTypeRemediator:
		agentConfig = pc.Remediator
	default:
		return nil
	}
...
func (pc *ProviderConfig) BuildOptionsMap() map[ProviderOptionsType][]llms.CallOption {
	...
	options := map[ProviderOptionsType][]llms.CallOption{
		...
		OptionsTypeExplainer:   pc.GetOptionsForType(OptionsTypeExplainer),
		OptionsTypeRemediator:  pc.GetOptionsForType(OptionsTypeRemediator),
	}

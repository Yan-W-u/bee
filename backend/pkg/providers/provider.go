...
type FlowProviderHandlers interface {
	...
	GetExplainerHandler(ctx context.Context, taskID, subtaskID *int64) (tools.ExecutorHandler, error)
	GetRemediatorHandler(ctx context.Context, taskID, subtaskID *int64) (tools.ExecutorHandler, error)

...
var ErrSwarmInvalidRequest = NewHttpError(400, "Swarm.InvalidRequest", "invalid swarm request data")
var ErrSwarmInvalidData = NewHttpError(500, "Swarm.InvalidData", "invalid swarm data")

// provider presets

var ErrProviderPresetInvalidRequest = NewHttpError(400, "ProviderPreset.InvalidRequest", "invalid provider preset request data")
var ErrProviderPresetNotFound = NewHttpError(404, "ProviderPreset.NotFound", "provider preset not found")

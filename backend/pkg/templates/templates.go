...
const (
	...
	PromptTypeExplainer                PromptType = "explainer"                  // analyzes discovered vulnerabilities and produces explanations
	PromptTypeQuestionExplainer        PromptType = "question_explainer"         // human input for vulnerability explanation
	PromptTypeRemediator               PromptType = "remediator"                 // generates precise remediation plans for vulnerabilities
	PromptTypeQuestionRemediator       PromptType = "question_remediator"        // human input for remediation planning
...
var PromptVariables = map[PromptType][]string{
	...
	PromptTypeQuestionExplainer: {
		"Question",
		"VulnerabilityContext",
	},
	PromptTypeRemediator: {
...
type AgentsPrompts struct {
	...
	Explainer     AgentPrompts
	Remediator    AgentPrompts
...
func GetDefaultPrompts() (*DefaultPrompts, error) {
	...
	return &DefaultPrompts{
		AgentsPrompts: AgentsPrompts{
			...
			Explainer: AgentPrompts{
				System: getPrompt(PromptTypeExplainer),
				Human:  getPrompt(PromptTypeQuestionExplainer),
			},
			Remediator: AgentPrompts{
				System: getPrompt(PromptTypeRemediator),
				Human:  getPrompt(PromptTypeQuestionRemediator),
			},
			ToolCallFixer: AgentPrompts{

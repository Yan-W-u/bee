...
const (
	...
	ExplainerToolName          = "explainer"
	ExplainerResultToolName    = "explainer_result"
	RemediatorToolName         = "remediator"
	RemediatorResultToolName   = "remediator_result"
...
var toolsTypeMapping = map[string]ToolType{
	...
	ExplainerToolName:          AgentToolType,
	ExplainerResultToolName:    StoreAgentResultToolType,
	RemediatorToolName:         AgentToolType,
	RemediatorResultToolName:   StoreAgentResultToolType,
...
var registryDefinitions = map[string]llms.FunctionDefinition{
	...
	ExplainerToolName: {
		...
		Description: "Call to vulnerability explanation specialist to analyze a discovered vulnerability, explain root cause, assess impact, and produce an understandable developer-oriented explanation",
		Parameters:  reflector.Reflect(&ExplainerAction{}),
	},
	ExplainerResultToolName: {
		Name:        ExplainerResultToolName,
		Description: "Send the vulnerability explanation report to the user with root cause analysis, impact assessment, CVSS score, and developer-facing summary",
		Parameters:  reflector.Reflect(&ExplainerResult{}),
	},
	RemediatorToolName: {
		Name:        RemediatorToolName,
		Description: "Call to remediation specialist to generate precise, actionable fixes for a discovered vulnerability including code patches, configuration changes, dependency upgrades, and temporary mitigations",
		Parameters:  reflector.Reflect(&RemediatorAction{}),
	},
	RemediatorResultToolName: {
		Name:        RemediatorResultToolName,
		Description: "Send the remediation report to the user with step-by-step fix instructions, code patches, verification steps, and complexity assessment",
		Parameters:  reflector.Reflect(&RemediatorResult{}),
	},
	AdviceToolName: {
		Name:        AdviceToolName,
